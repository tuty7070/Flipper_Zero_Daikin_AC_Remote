...
If you just want to run the app without setting up the source code, you can use the pre-compiled version!

1. Head over to the `dist` folder in this repository.
2. Download or run the compiled application file found inside.
